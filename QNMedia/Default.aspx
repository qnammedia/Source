...
<%@ Register Src="~/DesktopModules/Systems/Init.ascx" TagPrefix="dnn" TagName="Init" %>
...
<head id="Head" runat="server" ViewStateMode="Disabled">
    ...
    <meta content="Quảng Nam Media" name="keywords">
    <meta content="Đơn vị cung cấp các gói dịch vụ truyền thông, tư vấn, thiết kế, chuyển đổi số tại Quảng Nam" name="description">
    <meta property="og:url"           content="https://quangnammedia.vn" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="Công ty THNN Dịch vụ số Quảng Nam Media" />
    <meta property="og:description"   content="Đơn vị cung cấp các gói dịch vụ truyền thông, tư vấn, thiết kế, chuyển đổi số tại Quảng Nam" />
    <meta property="og:image"         content="https://quangnammedia.vn/images/logo.png" />
